...
trait QueryTrait
{
     ...
     * @return Users|false
     */
    protected function getUserByUsernameAndPassword(Config $config, Libmemcached $cache, $username)
    {
     ...
     * @return ResultsetInterface
     */
    protected function getRecordsPagination(
        Config $config,
        Libmemcached $cache,
        string $class,
        array $where = [],
